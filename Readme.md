...
Demo version will use spreadsheets to store data. It will not have the same capability and security than SQL version. LibreOffice is limited to 1 million rows. It is planned for only one user.
