...
Demo version is planned for only one user and will use spreadsheets to store data. It will not have the same features and security than SQL version. LibreOffice is limited to 1 million rows.
