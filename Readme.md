## Description
CustomPOS is a retail Point of Sale system. It is made of LibreOffice macros and SQL requests so that you can customize it with only basic programming skill.
