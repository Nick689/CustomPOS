## Description
CustomPOS is a retail Point of Sale system programmed with LibreOffice macros (visual basic) and SQL requests so that you can customize it with only basic programming skill.
