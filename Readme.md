## Description
CustomPOS is a retail Point of Sale system based on LibreOffice. It is programmed with only macro and SQL request so that CustomPOS is very easy to customize.    
