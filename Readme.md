...
- You can customize this program easily with only basic programing skill. Some module has to be rewritten to fit yours needs, but you will appreciate full control over the software.
