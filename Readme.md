...
CustomPOS's GUI has been designed to have the highest possible efficiency. That is why POS module is made of only one page without sub-page, only one popup validation will run invoice recording.
